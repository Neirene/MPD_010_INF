...
window.addEventListener('WebComponentsReady', function() {
	...
	var tableManager = new TableManager('/api/locations/' + id_location + '/sections');
	...
	tableManager.init('section-actions', filter);
	tableManager.editUrl = function(e){
		window.location = '/sections/' + e.detail + '?id_location=' + id_location + '&id_retailer=' + id_retailer;
	}
});