...
window.addEventListener('WebComponentsReady', function() {
	...
	var tableManager = new TableManager('/api/locations/' + id_location + '/trackers');
	...
	tableManager.init('tracker-actions', filter);
	tableManager.editUrl = function(e){
		window.location = '/trackers/' + e.detail + '?id_location=' + id_location + '&id_retailer=' + id_retailer;
	}
});