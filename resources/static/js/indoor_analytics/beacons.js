...
window.addEventListener('WebComponentsReady', function() {
	...
	var tableManager = new TableManager('/api/locations/' + id_location + '/beacons');
	...
	tableManager.init('beacons-actions', filter);
	tableManager.editUrl = function(e){
		window.location = '/beacons/' + e.detail + '?id_location=' + id_location + '&id_retailer=' + id_retailer;
	}
});